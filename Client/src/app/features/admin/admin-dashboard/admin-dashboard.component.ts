...
import { DashboardStats, RecentOrder, AdminNavItem, OrderStatus } from '../../../core/models/admin.model';
...
export class AdminDashboardComponent implements OnInit, OnDestroy {
  ...
  private initializeData(): void {
    ...
    this.navigationItems = this.adminService.getNavigationItems();
    ...
    this.subscriptions.push(
      this.adminService.dashboardStats$.subscribe(stats => {
    ...
    this.subscriptions.push(
      this.adminService.recentOrders$.subscribe(orders => {
  ...
  getStatusDisplayProperties(status: OrderStatus): { class: string; label: string } {
    return this.adminService.getStatusDisplayProperties(status);
  }
  ...
  // Track by function for orders list
  trackByOrderId(index: number, order: RecentOrder): string {
    return order.id;
  }

  // Get status CSS classes for order status badges
